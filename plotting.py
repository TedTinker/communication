...
def plots(plot_dicts, min_max_dict):
    ...
    for i, plot_dict in enumerate(plot_dicts):
        ...
        forward_losses_min_max = many_min_max([min_max_dict["rgbd_loss"], min_max_dict["sensors_loss"], min_max_dict["father_voice_loss"], min_max_dict["accuracy"]] + ([min_max_dict["mother_voice_loss"]] if args.joint_dialogue else []))
        ...
        curiosity_min_max = many_min_max(
            ...
            min_max_dict["hidden_state_curiosity"]] + ([min_max_dict["mother_voice_prediction_error_curiosity"], min_max_dict["mother_voice_hidden_state_curiosity"]] if args.joint_dialogue else []))
        ...
        def plot_prediction_error_curiosities(here, log = False, min_max = False):
            ...
            handles.append(awesome_plot(here, log_father_voice_prediction_error_dict if log else father_voice_prediction_error_dict, "green", "Father voice" if args.joint_dialogue else "Voice", min_max = this_min_max, letter = "F" if args.joint_dialogue else "V"))
            if(args.joint_dialogue):
        ...
        def plot_hidden_state_curiosities(here, log = False, min_max = False):
            ...
            handles.append(awesome_plot(here, log_father_voice_hidden_state_dict if log else father_voice_hidden_state_dict, "red", "Father voice" if args.joint_dialogue else "Voice", min_max = this_min_max, letter = "F" if args.joint_dialogue else "V"))
            if(args.joint_dialogue):
