...
parts = [
    ...
    Part(
        name = "palm",
        mass = arm_mass,
        size = (arm_thickness, palm_length, arm_thickness),
        joint_parent = "arm", 
        joint_origin = (arm_length / 2 - palm_length / 2, 0, 0), 
        joint_axis = (0, 1, 0),
        joint_type = "fixed",
        sensors = 1),
    ...
    Part(
        ...
        joint_parent = "palm", 
        joint_origin = (palm_length / 2 - arm_thickness / 2, 0, - hand_length / 2 - arm_thickness / 2), 
        joint_axis = (0, 1, 0),
        joint_type = "fixed",
        sensors = 1),
    ...
    Part(
        ...
        size = (arm_thickness, arm_thickness, hand_length),
        joint_parent = "palm", 
        joint_origin = (0, palm_length / 2 - arm_thickness / 2, - hand_length / 2 - arm_thickness / 2), 
        joint_axis = (0, 1, 0),
        joint_type = "fixed",
        sensors = 1),
