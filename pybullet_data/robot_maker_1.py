...
parts = [
    ...
    Part(
        name = "shoulder",
        mass = 10,
        size = (arm_thickness, arm_thickness, .8),
        joint_parent = "body", 
        joint_origin = (0, 0, .5 + arm_thickness / 2), 
        joint_axis = (0, 0, 1),
    ...
    Part(
        ...
        joint_parent = "shoulder", 
        joint_origin = (arm_thickness / 2 + arm_length / 2, 0, .2), 
        joint_axis = (0, 1, 0),
        joint_type = "fixed",
        sensors = 1),
    ...
    Part(
        ...
        joint_parent = "arm", 
        joint_origin = (arm_length / 2 - hand_length / 2, 0, -hand_length / 2 - arm_thickness / 2), 
        joint_axis = (0, 1, 0),
        joint_type = "fixed",
        sensors = 1),
...
robot_name = add_this + "robot_1.urdf"
with open(robot_name, 'w') as file:
    file.write(robot)
...
if(__name__ == "__main__"):
    ...
    robot_index = p.loadURDF("{}".format(robot_name), (-1, 0, 0), p.getQuaternionFromEuler([0, 0, pi/2]), 
